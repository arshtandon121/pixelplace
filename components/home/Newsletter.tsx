            ...
            <div className="max-w-xl">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
                    <input
                        ...
                        className="flex-1 px-4 py-3.5 bg-[var(--ks-lacquer-deep)] border border-[var(--ks-rule)] rounded-[4px] text-[var(--ks-champagne)] placeholder:text-[var(--ks-faint)] outline-none focus:border-[var(--ks-rule-strong)] text-base"
                    />
