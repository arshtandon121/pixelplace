  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family: Inter, Arial, sans-serif; background:#0b0b0b; color:#f5f5f5; padding:32px;">
        ...
        <p style="color:#d4d4d4; line-height:1.6;">Hi ${name}, ${details.kind === 'renewal' ? 'your listing was renewed and stays live on the canvas.' : 'your payment succeeded and your listing is now live on the PixelPlace canvas.'}</p>
        ...
        <p style="margin:24px 0;">
          <a href="${site}/dashboard" style="display:inline-block; background:#BF953F; color:#000; padding:12px 20px; border-radius:8px; text-decoration:none; font-weight:700;">View your listing</a>
        </p>
